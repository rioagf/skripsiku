	...
	<div class="row">
		<div class="col-12 col-md-12">
			<div class="card shadow">
				<form action="<?= base_url('adminarea/proses_tambah__gallery')?>" method="post" enctype="multipart/form-data">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<input type="text" name="nama_galeri" id="nama_galeri" class="form-control" required placeholder="Contoh: Galeri Bersama Client">
						</div>
						<div class="form-group">
							<label>File Gambar Galeri</label>
							<input type="file" name="images_galeri" id="images_galeri" class="form-control" accept="image/png, image/gif, image/jpeg" required>
						</div>
						<div class="form-group">
